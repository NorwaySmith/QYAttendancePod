...
#define H5BarTintColor [UIColor colorWithRed:36.f / 255.f green:187.f / 255.f blue:6.f / 255.f alpha:1.0]
@interface QYH5ProgressView()
@property (nonatomic) UIView *progressBarView;
@property (nonatomic) NSTimeInterval barAnimationDuration; // default 0.1
@property (nonatomic) NSTimeInterval fadeAnimationDuration; // default 0.27
@property (nonatomic) NSTimeInterval fadeOutDelay; // default 0.1
@end
@implementation QYH5ProgressView
...
-(void)configureViews
{
    ...
    _progressBarView.backgroundColor = H5BarTintColor;
