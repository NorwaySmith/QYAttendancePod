...
@interface Html5PlusTaskViewController ()<QYABProtocol> {
    MBProgressHUD *_hud;
...
@implementation Html5PlusTaskViewController
- (void)dealloc {
...
- (void)showWebView {
    ...
    if (pCoreHandle != nil) {
        ...
        //日志中的目录结构
        NSString *laterPath =
        @"Pandora/apps/task/www/task/html/tabList.html";
        NSString *pFilePath =
        ...
        appFrame = [[PDRCoreAppFrame alloc] initWithName:@"task"
                                                 loadURL:pFilePath
                                                   frame:StRect];
