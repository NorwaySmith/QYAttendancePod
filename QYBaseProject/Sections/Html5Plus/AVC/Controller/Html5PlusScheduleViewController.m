//
//  Html5PlusScheduleViewController.m
//  QYBaseProject
//
//  Created by zhaotengfei on 16/6/20.
...
@interface Html5PlusScheduleViewController ()<QYABProtocol> {
    MBProgressHUD *_hud;
...
@implementation Html5PlusScheduleViewController
- (void)dealloc {
...
- (void)showWebView {
    ...
    if (pCoreHandle != nil) {
        ...
        //日志中的目录结构
        NSString *laterPath =
        @"Pandora/apps/schedule/www/schedule/html/scheduleList.html";
        NSString *pFilePath =
        ...
        appFrame = [[PDRCoreAppFrame alloc] initWithName:@"schedule"
                                                 loadURL:pFilePath
                                                   frame:StRect];
