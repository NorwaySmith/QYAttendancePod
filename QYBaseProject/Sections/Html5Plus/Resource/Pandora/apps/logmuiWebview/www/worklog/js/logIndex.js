...
mui.plusReady(function() {
	...
	//我发布的 绑定方法
	mui("#myPublish")[0].addEventListener('tap', function(event) {
	...
	//我收到的 绑定方法
	mui("#myReceive")[0].addEventListener('tap', function(event) {
		window.location.href="logMyReceive.html";
		event.preventDefault();
	});

	//新建日志 绑定方法
	mui("#logAdd")[0].addEventListener('tap', function(event) {
		window.location.href="logAdd.html";
		event.preventDefault();
	});
