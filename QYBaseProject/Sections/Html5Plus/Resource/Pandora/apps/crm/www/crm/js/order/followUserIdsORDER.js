...
var initChanceInfo = function(id, callback){
	...
	var url = window.windowCommon.basePath + 'crm/order/findOrder.c';
...
//这个tapnum用来控制 changeownersubmit 方法的重复点击
...
var changeownersubmit = function(ownerid){
	...
	var url = window.windowCommon.basePath + 'crm/order/modifyOrderPart.c';
	mui.ajax(url, {
		data: data,
		dataType: 'json',
		type: 'post', //HTTP请求类型
